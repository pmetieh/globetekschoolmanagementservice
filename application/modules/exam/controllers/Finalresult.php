    ...
    * ********************************************************** */
    public function index() {
        ...
        if ($_POST) {
            ...
            if($exam_id){
                $this->data['exam'] = $this->result->get_single('exams', array('id'=>$exam_id, 'status' => 1, 'school_id'=>$school_id, 'academic_year_id'=> $school->academic_year_id));
            }else{
        ...
        $this->layout->title( $this->lang->line('manage_exam_final_result') . ' | ' . SMS);
